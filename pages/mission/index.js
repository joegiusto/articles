...
import MediaPhoto from 'public/images/mission/media.jpg';
        ...
        <div className='container-fluid container-custom container-mission'>
            ...
            <div className="mission-page">
                <div className="row h-100 justify-content-md-center">
                    ...
                    <div className="col-12 col-md-3 d-none d-lg-flex">
                        ...
                        <div className={"side-bar" + (shouldShowMenu ? ' out' : '')}>
                            ...
                            <div id="section-container">
                                ...
                                <div id="section-party" className="section-head">Politics</div>
                    ...
                    <div className="col-12 col-md-12 col-lg-9 col-xl-7 my-auto pl-lg-0">
                        ...
                        /> */}
                                ...
                                <div className="mission-section">
                                    ...
                                    <div style={{width: 'max-content'}} className="mx-auto">
                                        <Image 
                                            // className="news-media-image mb-4" 
                                            src={MediaPhoto}
                                            height="400"
                                            width="600"
                                            objectFit="contain"
                                ...
                                <div className="mission-section">
                                    ...
                                    <div className="sub-wrap pt-2">
                                        ...
                                        <div className="sub-text">
                                            ...
                                            <hr />
                                            <p className="mb-0">Joey here, Feel free to message me from the <Link href={ROUTES.TRANSPARENCY_EMPLOYEES + '/joey-giusto'}><span className="articles-inline-link noselect">here</span></Link> with suggestions.</p>
