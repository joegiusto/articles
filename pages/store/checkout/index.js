...
import { removeCartItem, clearCartItems } from 'redux/actions/cartActions';
import { addOrder } from "redux/actions/siteActions";
...
const CheckoutForm = (props) => {
    ...
    let userProductsToServer = () => {
        ...
        axios.post('/api/store/checkoutTotal', {
            products: [
    ...
    const handleSubmit = async (secret, paymentIntentID) => {
        ...
        if ( isSavedPayment ) {
            ...
            payload = axios.post('/api/store/checkoutWithPaymentMethod', {
        ...
        payload.then(data => {
            ...
            axios.post('/api/store/userMadePurchase', {
                payment: data,
    ...
    <div className="checkout-page new mb-5">
        ...
        <div className="cart">
            ...
            <div className="card-body border-top border-dark p-2">
                ...
                Payment succeeded, see the result in your
                    <Link href={ROUTES.SETTINGS_BILLING}>Account</Link>
                {/* <a
        ...
        <div className="details ">
            ...
            <div className="customer-info-cards">
                ...
                <div className="card mr-md-3 mb-3 w-100 shadow-sm">
                ...
                <div className="card payment-details mb-3 w-100 shadow-sm">
    ...
    return(
        <section className="submissions-page">
            ...
            <div className="container py-3">
                ...
                {/* {cartItems.map(item => <div>{item.description}</div>)} */}
...
Checkout.Layout = StoreLayout;
// export default Checkout;

const mapStateToProps = (state) => {
    return {
      productsUser: state.cart,
      user_details: state.auth.user_details
    };
};

CheckoutPage.Layout = StoreLayout;

const Test = connect(mapStateToProps, { removeCartItem, clearCartItems, addOrder })(CheckoutForm);
export default connect(mapStateToProps, { removeCartItem })( CheckoutPage );