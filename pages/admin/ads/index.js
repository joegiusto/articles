...
class Ads extends Component {
    ...
    fetchPopulation() {
      ...
      axios.post('/api/admin/ads/cityPopulation')
      .then(function (response) {
      ...
      return (
        <div className="admin-page admin-ads">
            ...
            <div className="side-panel">
                ...
                <Link href={ROUTES.ADVERTISING}>
                    <div className="btn btn-articles-light w-100 mb-2">
                        Advertising
                    </div>
                </Link>
    
                <Link href={ROUTES.ADVERTISING_ACCESS}>
                    <div className="btn btn-articles-light w-100 mb-2">
                        Advertising Access
                    </div>
                </Link>
    
                <Link href={ROUTES.ADVERTISING_MANAGE}>
                    <div className="btn btn-articles-light w-100 mb-2">
                        Advertising Manage
                    </div>
                </Link>
            ...
            <div className="map-container">
                ...
                <div className="map mb-3" style={{width: '100%', height: '500px'}}>
                    <Map userAreas={this.state.userAreas} ads={this.state.ads} lat={this.state.lat} lng={this.state.lng}/>
                </div>

                <div className="text-center d-flex align-items-center mb-2 flex-column flex-lg-row">
                    <h2 className="mr-lg-3">Ads</h2>
                    {/* <div className="text-muted mr-lg-3">{this.state.adPopulationFetched}</div> */}
                    {/* <div onClick={() => this.fetchPopulation()} className="btn btn-articles-light">Fetch Population (Temp)</div> */}
                </div>
                ...
                <div className="text-center d-flex align-items-center mb-2 flex-column flex-lg-row">
                    <h2 className="mr-lg-3">User Areas</h2>
                    <div className="text-muted mr-lg-3">{this.state.adPopulationFetched}</div>
                    <div onClick={() => this.fetchPopulation()} className="btn btn-articles-light">Fetch Population (Temp)</div>
                </div>
                        ...
                        <tbody>
                            ...
                            {this.state.userAreas.map( area=> 
                                <tr key={area.name}>
                                    ...
                                    <td colSpan="1" className="border-right-0 ">{ad.city}</td> */}
                                    <td colSpan="1" className="border-right-0 ">
                                        <span style={{width: "50px", fontSize: '0.9rem'}} className="text-muted d-inline-block">{area.zip} </span>
                                        {area.name}
                                    </td>
                                    <td colSpan="1" className="border-right-0 ">{area.amount}</td>
                                    {/* <td colSpan="1" className="border-right-0 ">1</td> */}
                                    {/* <td colSpan="1" className="border-right-0 ">0</td> */}
                                    {/* <td colSpan="1" width={'150px'} className="border-right-0 "><i className="far fa-edit mr-0"></i></td> */}
                                </tr>
      ...
      return (
        ...
        {this.props.userAreas.map(area => 
          ...
          <Area 
            ...
            advertiserCount={ this.props.ads.filter( ad => ad.zip == area.zip).length }
            name={area.name}
          />
        )}

        {this.props.ads.map(area => 
...
const Area = ({ ad, zip, userCount, advertiserCount, name }) => (
    <div>
        ...
        <div style={{
            color: ad ? 'white' : 'black',
            backgroundColor: ad ? 'red' : 'white', 
            display: 'block',
            textAlign: 'center',
            alignItems: 'center',
            justifyContent: 'center',
