    ...
    return (
        <div className="donate-form">
            ...
            <div className="inner card">
                ...
                <div className="name-plate card-body border border-dark ">
                ...
                <div className="name-plate">
                    ...
                    <div className="buttons mt-4">
                        <Link href={ROUTES.SIGN_UP}><div className="btn btn-articles-light">Sign Up</div></Link>
                        <Link href={ROUTES.SIGN_IN}><div className="btn btn-articles-light ml-2">Sign In</div></Link>
                    </div>
                ...
                onClick={() => tryIntent()}
                className={"pay w-100 btn btn-articles-light alt mx-auto mt-4"}
                >
                <span id="button-text">
                    {processing ? (
                ...
                <Link href={ROUTES.SETTINGS_ACCOUNT}>Account</Link>
                {/* <a
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-5">
                ...
                <div className="buttons mt-4">
                  <Link href={ROUTES.STORE}><div className="btn btn-articles-light">Shop Store</div></Link>
                  <Link href={ROUTES.STORE}><div className="btn btn-articles-light ml-2">Buy Membership</div></Link>
                </div>
