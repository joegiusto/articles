  ...
  <section className="landing-new">
    ...
    {/* <div className="content">
        ...
        <div className="container h-100">
          <div className="row align-items-center h-100">
            ...
            <div className="col-6 pl-md-0">
              <img height="376px" src="https://www.economist.com/sites/default/files/images/print-edition/20130921_USD000_0.jpg" alt=""/>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-4">
              ...
              <div className="opacity-panel">
                ...
                <div className="content-text pt-3">
                ...
                <img className="pt-4" src="https://www.economist.com/sites/default/files/images/print-edition/20130921_USD000_0.jpg" alt=""/>
              </div>
      ...
      <div className="full-screen-mod">
        ...
        {/* <div className="content h-100 d-flex h-100">
          <div className="row h-100 justify-content-center align-self-center">

            <div className="col-4 center-block">Interested?</div>
            <div className="col-4 center-block">Skeptical?</div>
