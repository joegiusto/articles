            ...
            <div className="col-lg-6">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <Link to={ROUTES.RESOURCES_POLITICIANS_HOUSE}><button className="mx-auto d-block btn btn-articles-light">Access</button></Link>
            ...
            <div className="col-lg-6">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <Link to={ROUTES.RESOURCES_POLITICIANS_SENATE}><button className="mx-auto d-block btn btn-articles-light">Access</button></Link>
