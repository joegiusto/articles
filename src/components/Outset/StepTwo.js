...
const StepTwo = (props) => (
  <div>
    ...
    <div className="cut-section text-center">
      <h5>Clothing Cut</h5>
      ...
      <button className="ml-2 btn btn-secondary">Skip</button>
    </div>

    <div className="shirt-section">
      <h5 className="text-center">Shirt Size</h5>
    ...
    <div className="shoe-section">
      <h5 className="text-center">Shoe Size</h5>
