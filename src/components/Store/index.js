			...
			<>
				<div className={"pop-out-viewer-container " + (this.props.match.params.id ? ' active' : '')}>
					...
					<div className="pop-out-viewer">
						...
						<div className="viewer-footer">
							<img src="https://images.unsplash.com/photo-1534298261662-f8fdd25317db?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" alt=""/>
						</div>
					</div>
				</div>
				...
				<div className='container store-page'>
					...
					<div className="featured-items">
						...
						{this.state.firebaseClothing.map(product => (
...
function StorePageOld(props) {
	...
	return (
	<>
		<div className={"pop-out-viewer-container " + (props.match.params.id ? ' active' : '')}>
			<Link to={ROUTES.STORE} onClick={() => setPopOutVisible(false)}>
				<div className="background"></div>
			</Link>
			<div className="pop-out-viewer">
				<div className="viewer-nav">
					<Link to={ROUTES.STORE}><div onClick={() => setPopOutVisible(false)} className="close-button"></div></Link>
				</div>
				<div className="viewer-body">
					<div className="row justify-content-between">
						<div className="col-6">
						...
						<div className="col-4 border-left">
							<div className="detail-container">
								...
								<div>Realesed | 00/00/0000</div>
								<div>Made In | United States</div>
								<div>Material | 50% Cotton, 50% Elastic</div>
								<div>Manufacture Cost | $20</div>
								<div>Sale Price | $40</div>
								<button className="btn btn-articles-light">Add to Cart</button>
							</div>
						</div>
					</div>
		...
		<div className='container store-page'>
			...
			<div className="featured-items">
				...
				<h1 className="mt-2 mt-md-4 store-heading">Firebase</h1>
				...
				<div className="featured-items">
					...
					<StoreItem setPopOutVisible={setPopOutVisible} catalogId='1' price={3000} title="Wolf Hoodie" sale="%15" banner="Original" color="articles" />
		
					<StoreItem setPopOutVisible={setPopOutVisible} catalogId='2' price={3000} title="Sheep Hoodie" sale="%15" banner="Original" color="articles"/>
		
					<StoreItem setPopOutVisible={setPopOutVisible} catalogId='3' price={2500} title="Partner Item" sale="%15" banner="Partner" color="info"/>
		
					<StoreItem setPopOutVisible={setPopOutVisible} catalogId='4' price={2000} title="Sponsered Item" sale="%15" banner="Sponsered" color="danger"/>
		
					<StoreItem setPopOutVisible={setPopOutVisible} catalogId='5' price={2000} title="Sponsered Item" sale="%15" banner="Sponsered" color="primary"/>
