...
import PresidentCard from 'components/News/Resources/Presidents/PresidentCard'

export default function PresidentsResource(props) {
    ...
    const handleClose = () => { setShow(false); setActivePresidentID(''); setActivePresident({}); router.push(ROUTES.RESOURCES_PRESIDENTS); }
    ...
    useEffect(() => {
        ...
        axios.get('/api/news/resources/presidents', {
        ...
        <section className="presidents-page">
            ...
            <div className="page-header shadow-sm">
                ...
                <div className="container py-3">
                    ...
                    <h1 className="mt-3">Explore Presidents {show ? 'true' : "false"}</h1>
            ...
            {presidentsLoading && (
                <div className="d-flex justify-content-center">
                    <div className="loading-block mx-auto my-3">
                        <div>
            ...
            <div className="presidents-grid-container container">
                ...
                <div className="presidents-grid py-3">
                    ...
                    {filterOrderRules(presidents).map((president, i) =>
                        <Link key={president._id} scroll={false} href={`${ROUTES.RESOURCES_PRESIDENTS}/${president._id}`} onClick={() => { setShow(true); setActivePresidentID(president._id); }}>
                            <a><PresidentCard i={i} president={president} /></a>
                        </Link>
                    )}
